document.addEventListener("DOMContentLoaded", function () {
    const products = [
        { name: "dark roast coffee", price: "12.99€", image: "product1.png" },
         {name: "matcha green tea", price: "14.99€", image: "product2.png" },
         {name: "cytrus energy drink", price: "2.99€", image: "product3.png" }
    ];
